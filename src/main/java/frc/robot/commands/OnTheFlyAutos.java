...
//     public OnTheFlyAutos(Arm arm, Shooter shooter, Intake intake, CommandSwerveDrivetrain drivetrain, CommandXboxController xboxController){
//     this.arm = arm;
...
//     groupCommands = new FactoryCommands(arm, shooter, intake, drivetrain, xboxController);
//   }
...
//   //   BooleanSupplier reason = ()->drivetrain.isPiecePresent() && CommandSwerveDrivetrain.poseWithinRange(drivetrain.getPiecePose().get(),new Pose2d(8.29,7.42,new Rotation2d()),.2);
